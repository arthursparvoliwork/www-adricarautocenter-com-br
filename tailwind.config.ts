...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        display: ['"Russo One"', '"Racing Sans One"', "sans-serif"],
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(0 100% 55% / 0.4), 0 0 40px hsl(0 100% 50% / 0.2)" },
          "50%": { boxShadow: "0 0 40px hsl(0 100% 55% / 0.7), 0 0 80px hsl(0 100% 50% / 0.4)" },
        },
      ...
      animation: {
        ...
        "speed": "speed 2.5s ease-in-out infinite",
