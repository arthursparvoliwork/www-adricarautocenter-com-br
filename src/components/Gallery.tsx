...
const items = [
  { img: mecanico, label: "Mão de obra especializada", category: "Mecânica" },
  { img: oficina, label: "Diagnóstico de motor", category: "Injeção" },
  { img: roda, label: "Rodas e pneus premium", category: "Pneus" },
  { img: escapamentos, label: "Estoque de escapamentos", category: "Escape" },
  { img: freios, label: "Sistema de freios", category: "Freios" },
  { img: diagnostico, label: "Scanner automotivo", category: "Diagnóstico" },
];
      ...
      <div className="container-x">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
          {items.map((it, i) => (
            <div
              key={it.label}
              className={`group relative overflow-hidden rounded-2xl border border-border hover:border-primary/60 transition-all duration-500 ${
